Polymers are inherently scratch-sensitive due to their soft nature. Utilizing patterned surfaces while retaining transparency is a viable strategy for better scratch performance. The effect of two different pattern types on scratch behavior is studied and the experimental results are validated using FEM simulation by employing COF and Fluid-structure simulations. Results show the significance of patterned surface topology in improving scratch performance.
...
## COF Simulation
Flat
![Flat](https://github.com/user-attachments/assets/eb74dff3-506a-44e7-b505-2731a7900629)
Pillars
![Pillars](https://github.com/user-attachments/assets/26bc387b-0b23-43af-958e-0a30501b05f2)
Holes
![Holes](https://github.com/user-attachments/assets/baf7255f-59e8-4902-af08-f3b66988b5ae)
